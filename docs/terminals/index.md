...
iTerm2 is a popular terminal emulator for macOS. It provides a number of features and enhancements over the default macOS terminal application, including split panes, mouseless copy, and advanced search.

Learn more about iTerm2 [here](https://iterm2.com/).
