...
You can download Git from the [official Git website](https://git-scm.com/downloads), and you can download Jekyll by following the [Jekyll installation instructions](https://jekyllrb.com/docs/installation/).
...
5. Open a web browser and navigate to the following URL:
    ...
    This will launch the site in your web browser.
